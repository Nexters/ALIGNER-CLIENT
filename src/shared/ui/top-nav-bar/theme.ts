export const TOP_NAV_BAR_BASE = "flex h-[5.6rem] w-full items-center gap-[1rem]";
...
export const BACK_BUTTON_FILL =
  "absolute inset-[0.8px] rounded-full pointer-events-none [background:linear-gradient(135deg,color-mix(in_srgb,var(--color-black)_10%,transparent)_0%,transparent_70%,color-mix(in_srgb,var(--color-white)_35%,transparent)_100%)]";
