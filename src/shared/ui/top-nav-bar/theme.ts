...
export const BACK_BUTTON_WRAPPER =
  "relative size-[4.4rem] shrink-0 rounded-full shadow-[0px_0.8rem_4rem_0px_color-mix(in_srgb,var(--color-black)_12%,transparent)]";
...
export const BACK_BUTTON_FILL_CLIP =
  "absolute inset-px overflow-hidden rounded-full pointer-events-none";
export const BACK_BUTTON_FILL_WHITE = "absolute inset-0 bg-white/40";
export const BACK_BUTTON_FILL_DIAGONAL =
  "absolute inset-0 [background:linear-gradient(135deg,color-mix(in_srgb,var(--color-black)_12%,transparent)_0%,transparent_45%,color-mix(in_srgb,var(--color-white)_35%,transparent)_100%)]";
